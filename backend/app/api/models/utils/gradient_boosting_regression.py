...
class GradientBoostingRegressionModel:
    ...
    def train(self, model_name='gradient_boosting_model.pkl', n_estimators=100, learning_rate=0.1, 
    ...
    def evaluate(self):
        ...
        # Get training history (deviance scores)
        ...
        result = {
            ...
            "training_history": {
                "iterations": list(range(len(train_score))),
    ...
    def get_learning_curves(self):
        """Generate learning curves showing training error over iterations."""
        if not hasattr(self, 'model'):
            raise ValueError("Model has not been trained or loaded. Call 'train()' or 'load_model()' first.")
        ...
        return {
            ...
            "training_score": train_scores.tolist()
        }