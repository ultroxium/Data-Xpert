const AreaChart = React.lazy(
  () => import("@/components/data/visualize/chart-lists/AreaChart")
);
const BarChart = React.lazy(
  () => import("@/components/data/visualize/chart-lists/BarChart")
);
...
const Doughnut = React.lazy(
  () => import("@/components/data/visualize/chart-lists/DouhnutChat")
);
...
const LineChart = React.lazy(
  () => import("@/components/data/visualize/chart-lists/LineChart")
);
const PiePlot = React.lazy(
  () => import("@/components/data/visualize/chart-lists/PieChart")
);
